...
public enum FMCrop: FMCroppable {
    ...
    public func icon() -> UIImage {
        ...
        switch self {
        case .ratio4x3:
            icon = UIImage(named: "icon_crop_4x3", in: .module, compatibleWith: nil)
        case .ratio16x9:
            icon = UIImage(named: "icon_crop_16x9", in: .module, compatibleWith: nil)
        case .ratio9x16:
            icon = UIImage(named: "icon_crop_9x16", in: .module, compatibleWith: nil)
        case .ratioCustom:
            icon = UIImage(named: "icon_crop_custom", in: .module, compatibleWith: nil)
        case .ratioOrigin:
            icon = UIImage(named: "icon_crop_origin_ratio", in: .module, compatibleWith: nil)
        case .ratioSquare:
            icon = UIImage(named: "icon_crop_square", in: .module, compatibleWith: nil)
        }
        if icon != nil {
            return icon!
        }
