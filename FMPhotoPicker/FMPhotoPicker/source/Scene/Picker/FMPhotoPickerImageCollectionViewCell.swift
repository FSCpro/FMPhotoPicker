...
class FMPhotoPickerImageCollectionViewCell: UICollectionViewCell {
    ...
    private func setupView() {
        ...
        videoIcon.image = UIImage(named: "video_icon", in: .module, compatibleWith: nil)
        ...
        editedMarkImageView.image = UIImage(named: "icon_edited", in: .module, compatibleWith: nil)
    ...
    func performSelectionAnimation(selectedIndex: Int?) {
        if let selectedIndex = selectedIndex {
            if self.selectMode == .multiple {
                ...
                self.selectButton.setImage(UIImage(named: "check_on", in: .module, compatibleWith: nil), for: .normal)
            } else {
                self.selectedIndex.isHidden = true
                self.selectButton.setImage(UIImage(named: "single_check_on", in: .module, compatibleWith: nil), for: .normal)
            }
            self.cellFilterContainer.isHidden = false
        } else {
            self.selectedIndex.isHidden = true
            self.cellFilterContainer.isHidden = true
            self.selectButton.setImage(UIImage(named: "check_off", in: .module, compatibleWith: nil), for: .normal)
        }
    }
}
