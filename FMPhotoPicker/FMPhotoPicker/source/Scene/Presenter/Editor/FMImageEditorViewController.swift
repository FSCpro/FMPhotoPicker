...
public class FMImageEditorViewController: UIViewController {
    ...
    override public func viewDidLoad() {
        ...
        DispatchQueue.main.async {
            ...
            let filterTintIcon = UIImage(named: "icon_filter", in: .module, compatibleWith: nil)?.withRenderingMode(.alwaysTemplate)
            self.filterMenuButton.setImage(filterTintIcon, for: .normal)
            
            let cropTintIcon = UIImage(named: "icon_crop", in: .module, compatibleWith: nil)?.withRenderingMode(.alwaysTemplate)
