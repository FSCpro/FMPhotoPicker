...
class FMPlaybackControlView: UIView {
    ...
    init() {
        ...
        playButton.setImage(UIImage(named: "icon_play_small", in: .module, compatibleWith: nil), for: .normal)
    ...
    private func updatePlayButton() {
        if isPlaying {
            ...
            playButton.setImage(UIImage(named: "icon_pause_small", in: .module, compatibleWith: nil), for: .normal)
        } else {
            playButton.isHidden = false
            playButton.setImage(UIImage(named: "icon_play_small", in: .module, compatibleWith: nil), for: .normal)
        }
